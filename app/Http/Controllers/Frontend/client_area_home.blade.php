    ...
    <div class="container">
        ...
        <div class="one_fourth_less">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item"><div class="dark"><b>Name:</b></div>Hock Lim</li>
                <li class="list-group-item alt"><div class="dark"><b>Email:</b></div>hock@webqom.com</li>
    	...
    	<div class="three_fourth_less last">
          ...
          <div class="text-18px dark light">Welcome Back, Hock</div>
