...
$('#todos-list-sort li a.delete').on('click', function () {
        $(this).parent().remove();
    });
    //END TODOS LIST
    ...
    if($('#earning-chart-web-design').length != 0) {
    ...
    if($('#earning-chart-shared').length != 0) {
    ...
    if($('#earning-chart-dedicated').length != 0) {
    ...
    if($('#earning-chart-email88').length != 0) {
    ...
    if($('#internet-speed-chart').length != 0) {
...
$('#clients_list thead input[type="checkbox"]').on('click',function(){
    if($(this).is(":checked")){
       $('#clients_list tbody input[type="checkbox"]').prop('checked', true);
    }else{
       $('#clients_list tbody input[type="checkbox"]').prop('checked', false);
    }
});
