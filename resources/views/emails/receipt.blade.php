																	...
																	<td align="center" valign="top" class="mob_center">
																		<a href="#" target="_blank" style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 13px;">
																			<font face="Arial, Helvetica, sans-seri; font-size: 13px;" size="3" color="#596167">
																				<img style="height:100%;width:auto;" align="middle" src="http://ecommerce.webqom.com/resources/assets/frontend/images/index/logo.png" alt="Webqom" border="0" width="203px" height="50px" style="display: block;margin: auto; !important" />
																			</font>
																		</a>
																	</td>
																</tr>
										...
										<td align="center">
											<font face="Arial, Helvetica, sans-serif" size="3" color="#96a5b5" style="font-size: 13px;">
												<span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; color: #96a5b5;">
													{{ date('Y') }} &copy; {{ config('app.name') }}</span>
											</font>
										</td>
									</tr>
								</table>
