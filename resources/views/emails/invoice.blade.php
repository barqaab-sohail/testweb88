						...
						<tr><td align="center" valign="middle">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" >
								<tr><td align="center" valign="top" class="mob_center">
									...
									<img style="height:100%;width:auto;" align="middle" src="http://ecommerce.webqom.com/resources/assets/frontend/images/index/logo.png" alt="Webqom" border="0" width="203px" height="50px" style="display: block;margin: auto; !important" /></font></a>
								</td></tr>
							</table>
						</td></tr>
					</table>
								...
								<div style="line-height: 24px;">
									<font face="Arial, Helvetica, sans-serif" size="4" color="#57697e" style="font-size: 16px;">
										<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
											...
											Hello, <b>{{ $name }}</b><br>
											Greetings<br><br>
											Your Invoice is Attached.<br>											
											Thanks for using Webqom Technologies Services<br><br>
											Yours sincerely, <br>
											Webqom Technologies Sdn Bhd <br>
											www.webqom.com.my <br>
											www.{{ config('app.name') }}
										</span>
									</font>
								</div>
