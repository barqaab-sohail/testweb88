...
<div class="content_fullwidth">
    ...
    <div class="container" id="scroll_here">
        ...
        <ul class="tabs clearfix">
            <li class="animate fadeInUp active" data-anim-type="fadeInUp" data-anim-delay="100"><a href="javascript:void(0)" onclick="$('.tabs-panel').hide();$('#tab-1').show();" target="_self"><i class="fa icon-pencil"></i>My Details</a></li>
            <li class="animate fadeInUp" data-anim-type="fadeInUp" data-anim-delay="200"><a id="change_password_tab" href="javascript:void(0)" onclick="$('.tabs-panel').hide();$('#change-password').show();" target="_self"><i class="fa icon-lock"></i>Change Password</a></li>
        </ul>
