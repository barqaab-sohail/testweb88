                    ...
                    @foreach($article->list_articles as $list)
                      <div class="cd-timeline-block">
                        ...
                        <div class="cd-timeline-content">
                          <h2><a href="{{ route('frontend.articles.show', ['id'=>$list->id,'slug'=>$list->title])}}">{{$list->title}}</a></h2>
                          <p class="text">{{ str_limit($list->description, 100, '...')}}</p>
                          <a href="{{ route('frontend.articles.show', ['id'=>$list->id,'slug'=>$list->title]) }}" class="cd-read-more">Read more</a> <span class="cd-date"><strong>{{ $list->PostDateMonthInMiddle }}</strong></span> </div>
                        <!-- cd-timeline-content --> 
                      </div>
                      <!-- cd-timeline-block -->
                    @endforeach
