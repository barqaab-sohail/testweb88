...
@section('meta_description',$article->meta_descriptions)
@section('title',$title)
                     ...
                     <div class="popular-posts-area">
                        <h5 class="caps">Recent Posts</h5>
                            ...
                            <ul class="recent_posts_list">
                                ...
                                <li>
                                    <span><a href="{{ route('frontend.articles.show', ['id'=>$rp->id,'slug'=>$rp->title])}}"><img src="{{url('').'/storage/articles/front_image/'. $rp->front_image}}" alt="" height="100px" width="100px" /></a></span>
                                    <a href="{{ route('frontend.articles.show', ['id'=>$rp->id,'slug'=>$rp->title])}}">{!! $rp->title !!}</a>
                     ...
                     <div class="popular-posts-area">
                        <h5 class="caps">Popular Posts</h5>
                            ...
                            <ul class="recent_posts_list">
                                ...
                                <li>
                                    <span><a href="{{ route('frontend.articles.show', ['id'=>$pop_post->id,'slug'=>$pop_post->title])}}"><img src="{{url('').'/storage/articles/front_image/'. $pop_post->front_image}}" alt=""  height="100px" width="100px" /></a></span>
                                    <a href="{{ route('frontend.articles.show', ['id'=>$pop_post->id,'slug'=>$pop_post->title])}}">{!! $pop_post->title !!}</a>
            ...
            <div class="one_fourth last">
                ...
                <div class="sidebar_widget">
                    ...
                    <ul class="arrows_list1">
                        ...
                        <li><a href="/blog#tab-{{$x}}"><i class="fa fa-caret-right"></i>{{$ga->post_date->format('Y')}}</a></li>
                        @php
                        $x++;
                        @endphp
                        @endforeach
                    ...
                    <div class="tab_container"> 
                        <div id="tab1" class="tab_content"> 
                            ...
                            <ul class="recent_posts_list">
                                ...
                                <li>
                                    <span><a href="{{ route('frontend.articles.show', ['id'=>$pp->id,'slug'=>$pp->title])}}"><img src="{{url('').'/storage/articles/front_image/'. $pp->front_image}}" alt="" width="100px" height="100px" /></a></span>
                                    <a href="{{ route('frontend.articles.show', ['id'=>$pp->id,'slug'=>$pp->title])}}">{!! $pp->title !!}</a>
                        ...
                        <div id="tab2" class="tab_content">  
                            <ul class="recent_posts_list">
                                ...
                                <li>
                                    <span><a href="{{ route('frontend.articles.show', ['id'=>$rec_post->id,'slug'=>$rec_post->title])}}"><img src="{{url('').'/storage/articles/front_image/'. $rec_post->front_image}}" alt="" height="100px" width="100px" /></a></span>
                                    <a href="{{ route('frontend.articles.show', ['id'=>$rec_post->id,'slug'=>$rec_post->title])}}">{!! $rec_post->title !!}</a>
...
<div class="clearfix"></div>
<div class="container feature_section107"><br /><h1 class="caps light">Learn more about <b>Web88 CMS System</b>  <a href="../services/web88_cms">Go!</a></h1></div>
@endsection
...
<!-- for kenetic word rotator js-->
<script src="{{url('').'/resources/assets/frontend/'}}js/theme-word-rotator.js"></script>
<script src="{{url('').'/resources/assets/frontend/'}}js/plugins.min.js"></script>
