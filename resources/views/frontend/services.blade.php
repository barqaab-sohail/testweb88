...
@if(isset($cms->page_title) && $cms->meta_status != 2)
@section('title', $cms->page_title .' | - Webqom Technologies')
@else
@section('title', ucwords($page_name) .' | - Webqom Technologies')
@endif

@if(isset($cms->meta_keyword) && $cms->meta_status != 2)
@section('meta_keyword', $cms->meta_keyword)
@endif
@if(isset($cms->meta_description) && $cms->meta_status != 2)
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <select class="form-control input-medium">
                                    ...
                                    <option value="{{ $loop->index + 1 }} year" {{ $loop->index == 1 ? 'selected="selected"' : '' }}>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('frontend.domain.whois', $key) }}">WHOIS</a>
                                @endif
                            </td>
                            <td>
    ...
    <div class="plan">
        <div class="container">
            ...
            <h3 class="light red">
                ...
                <span><a href="/services/single_domain_search?search_domain={{ $key }}" class="btn-sm btn-danger caps"><i class="fa icon-basket-loaded"></i>
                        <b>Add</b></a>&nbsp;</span>
            </h3>
...
<div class="page_title1 sty7">
    ...
    <div class="serch_area">
        ...
        <div class="molinks"><a href="{{ route('frontend.services', 'bulk_domain_search') }}">
                <i class="fa fa-caret-right"></i> Bulk Domain Search</a> <a href="{{ route('frontend.services', 'bulk_domain_transfer') }}"><i class="fa fa-caret-right"></i> Bulk Transfer</a>
        </div>
    </div><!-- end section -->
</div><!-- end page title -->
        ...
        <div class="container">
            ...
            <h3 class="light red">
                <i class="fa fa-times-circle"></i> Sorry! <strong>{{ $response->domain }} does not
                    appear to be registered yet.</strong> Try registering this domain instead.
                <span><a href="/services/single_domain_search?search_domain={{ $response->domain }}" class="btn-sm btn-danger caps"><i class="fa icon-basket-loaded"></i>
                        <b>Add</b></a>&nbsp;</span>
            </h3>
    ...
    <div class="container">
        ...
        <div class="one_fifth_less @if ($count % 5==0) last @endif">
            <h5 class="caps">
                ...
                <i class="fa {{ $i->icon }}"></i>
                @else
                <img src="{{ asset('/storage/general_features/icon_images/' . $i->icon_image) }}" style="display: block;" />
                @endif
                        ...
                        <table class="table table-hover table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @for ($i = 1; $i <= count($prices); $i++) @if ($i==1 || $i==2 || $i==3 || $i==5 || $i==10) <td class="alicent">
                        ...
                        <table class="table table-hover table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><b>{{ $dpl->tld }}</b></td>
                                    @for ($i = 1; $i <= count($prices); $i++) @if ($i==1 || $i==2 || $i==3 || $i==5 || $i==10) <td class="alicent"><span class="red">RM {{ $prices[$i]['s'] }}
                                            *</span><br />
                                        <span class="strike">RM
                                            {{ $prices[$i]['l'] }}*</span>
                                        </td> @endif
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @for ($i = 1; $i <= count($prices); $i++) @if ($i==1 || $i==2 || $i==3 || $i==5 || $i==10) <td class="alicent"><span class="red">RM {{ $prices[$i]['s'] }}
                                        ...
                                        @endfor
                                        <td><a href="{{ url('/shopping_cart') }}" class="btn-sm btn-danger caps"><i class="fa icon-basket-loaded"></i> <b>Buy</b></a>
                                        </td>
                                </tr>
                                @endif
                                @endforeach
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @for ($i = 1; $i <= count($prices); $i++) @if ($i==1 || $i==2 || $i==3 || $i==5 || $i==10) <td class="alicent"><span class="red">RM {{ $prices[$i]['s'] }}
                                        ...
                                        @endfor
                                        <td><a href="{{url('/shopping_cart')}}" class="btn-sm btn-danger caps"><i class="fa icon-basket-loaded"></i>
                                                <b>Buy</b></a>
                                        </td>
                                </tr>
                                @endif
...
<link rel="stylesheet" href="{{ asset('resources/assets/frontend/js/masterslider/skins/default/style.css') }}" />
