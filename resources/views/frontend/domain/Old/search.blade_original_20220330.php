...
@section('content')
    ...
    <div class="page_title1 sty7">
        ...
        <div class="serch_area">
            ...
            <br />
            <div class="molinks">
                <a href="{{route('frontend.services', 'bulk_domain_search')}}"><i class="fa fa-caret-right"></i> Bulk Domain Search</a>
    ...
    <div class="one_full stcode_title9 title_scroll">
...
@section('custom_scripts')
    ...
    $.ajax({
         type:'POST',
         url:'/add_to_cart',
         data: {domain: domain, qty: qty, price: price, cycle: cycle, type:type },
