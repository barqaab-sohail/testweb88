...
@section('title','Admin | Domain Addons Pricing- Listing')
@section('content')
                                      ...
                                      <form id="add_new_frm" class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="btn-group btn-toggle"> 
                                                  <button type="button" onclick="active_inactive_create(1,this)" class=" status_change_create active btn btn-primary ">ACTIVE</button>
                                                  <button type="button" onclick="active_inactive_create(0 , this)" class="btn btn-default  status_change_create ">INACTIVE</button>
                                                  <input type="hidden" name="status" value="1" id="user_status_created">
                                            </div>
                                          </div>
                                        </div>
                                        <div class="form-group">
                                              ...
                                              <div class="form">
                                                ...
                                                <div class="form-group">
                                                  <label class="col-md-3 control-label">Status</label>
                                                   <br>
                                                  <div class="btn-group btn-toggle"> 
                                                  <button type="button" onclick="active_inactive(1,this)" class=" status_change {{$i->status == 1 ? 'active btn btn-primary' : 'btn btn-default'}}">ACTIVE</button>
                                                  <button type="button" onclick="active_inactive(0 , this)" class="btn  status_change {{$i->status == 0 ? 'active btn btn-primary' : 'btn-default'}}">INACTIVE</button>
                                                  <input type="hidden" name="status" value="{{$i->status}}" id="user_status">
                                                </div>
                                                  <!-- <div class="col-md-6">
...
//                                $('#modal-add-form').removeData();
        ...
        function open_modal_delete_selected() {
           ...
           function active_inactive_create(status , ele){
            $(".status_change_create").removeAttr('class').addClass("status_change_create btn btn-default");
              $(ele).addClass('status_change btn btn-primary active');
             $("#user_status_created").val(status);
           }
            function active_inactive(status,ele){
              $(".status_change").removeAttr('class').addClass("status_change btn btn-default");
              $(ele).addClass('status_change btn btn-primary active');
