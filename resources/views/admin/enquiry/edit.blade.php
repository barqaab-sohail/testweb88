...
if(isset($_GET['type'])){
   ...
   $breadcrumbs=[
        array('url'=>url('/admin/services/enquiry/list'),'name'=>'Services Enquiry'),
        array('url'=>url('/admin/support_tickets'),'name'=>'Ask For Quote - Listing'),
...
@section('content')
@if(isset($_GET['type']))
@section('page_header','Ask For Quote')
@else
@section('page_header','Services Enquiry')
@endif
        ...
        <div class="col-lg-12">
            ...
            <div class="portlet">
                <div class="portlet-header">
                    @if(isset($_GET['type']))
                    <div class="caption">Edit Ask For Quote </div>&nbsp;
                    @else
                    <div class="caption">Edit Service Enquiry</div>&nbsp;
                    @endif
                </div>
                <div class="portlet-body">
                  <div class="row">
                    <div class="col-lg-10 col-lg-offset-1">
                      <form action=" {{ asset(route('enquires-update', $enquiry->id)) }}" method="POST">
                          {{ csrf_field() }}
                          ...
                          <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="service"  name="service" value="{{ $enquiry->service }}">
                              </div>
                              <div class="form-group">
                                  <label for="name">Name:</label><br>
                                  <input type="text" class="form-control" id="name"  name="name" value="{{ $enquiry->name }}">
                              </div>
                              <div class="form-group">
                          ...
                          <div class="col-md-6">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="phone"  name="phone" value="{{ $enquiry->phone }}">
                              </div>
                              <div class="form-group">
                                  <label for="website">Website:</label>
                                  <input type="text" class="form-control" id="website"  name="website" value="{{ $enquiry->website }}">
                              </div>
                          </div>
                          <div class="col-md-12">
                              <div class="form-group">
                                  <label for="message">Message:</label>
                                  <textarea name="message" class="form-control" id="message"  name="message">{{ $enquiry->message }}</textarea>
                              </div>
                            
                          <input type="submit" value="Update" class="btn btn-common">
                          <a href="/admin/support_tickets" class="btn btn-green">Back</a>
                          </div>
                      </form>
                    </div>
                  </div>
