                        ...
                        <div class="portlet-header">
                          ...
                          <div class="btn-group">
                            ...
                            <button type="button" data-toggle="dropdown" class="btn btn-red dropdown-toggle"><span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button>
                              ...
                              <li class="divider"></li>
                              <li>
                                <a href="#" data-target="#modal-delete-all" data-toggle="modal">Delete all</a></li>
                              </ul>
                          </div>
...
yourdomain.net
                                            ...
                                            <tr>
                                                ...
                                                <td class="thick-line text-right" colspan="2"><h6><b>RM 26,406.54</b></h6></td>
                                                <td class="thick-line text-right"></td>
                                            </tr>
                                            <tr>
                                                <td class="no-line" colspan="5"></td>
                                                <td class="no-line text-right"><h6 class="text-red"><b>Discount:</b></h6></td>
                                                <td class="no-line text-right" colspan="2"><h6 class="text-red"><b>- RM 1,211.40</b></h6></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="thick-line text-right" colspan="2"><h5 class="text-red"><b>RM 25,195.14</b></h5></td>
                                                <td class="thick-line text-right"></td>
                                            </tr>
                                            </tbody>
                                        </table>
                  ...
                  <div class="table-responsive mtl">
                    <table id="example1" class="table table-hover table-striped">
                      ...
                      <tfoot>
                      	 <tr>
                         	<td colspan="4"></td>
                            <td class="text-left"><h5 class="text-red"><b>Balance:</b></h5></td>
                            <td class="text-left"><h5 class="text-red"><b>RM {{ number_format($data['order']->total_amount, 2) }}</b></h5></td>
                            <td></td>
                         </tr>
                      </tfoot>
                    </table>
