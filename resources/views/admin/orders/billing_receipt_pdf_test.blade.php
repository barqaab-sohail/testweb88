    ...
    <div class="align-items-center">
                ...
                <tr>
                    ...
                    <td valign="top">
                        <table width="300" cellpadding="0" cellspacing="0">
                            <tr>
                                <td valign="top">
                                    <h1 class="green caps" style="margin-bottom:0;text-align:center"
        ...
        <table width="100%" cellspacing="0" cellpadding="0">
            <tbody>
                <tr>
                    <td width="width:100%">
                        <div style="float:left; width:50%"><span style="margin-right:15px;">Invoice Date : </span><span
                                style="margin-left:30px;display:inline">{{ date('jS M Y',
            ...
            <tbody>
                ...
                <tr>
                    <td class="alileft">{{ $orderDetails->user->client->first_name }}
                        {{ $orderDetails->user->client->last_name }}</td>
                </tr>
                <tr>
                        ...
                        <div class="pull-left">
                            ...
                            ?>
                                <li><i class="fa icon-arrow-right"></i>{{ $dprice->title }} (RM
                                    {{ number_format($dprice->price, 2) }})</li>
                                <?php }
                            ?>
                                @endforeach
                                @endforeach
