...
$breadcrumbs=[
             // array('url'=>url('orders/listing'),'name'=>'Orders'),
              array('url'=>url('orders'),'name'=>'Orders - Listing'),
...
@section('page_header','Orders')
        ...
        <div class="page-content">
          <input type="hidden" id="sortcountry" value="{{ request()->sort }}">
          <div class="row">
            <div class="col-lg-12">
              ...
              @if (session('delete_status') && session('delete_status') === True)
                <div class="alert alert-success delete-success">
                  ...
                  <i class="fa fa-check-circle"></i> <strong>Success!</strong>
                  <p>Order(s) has been deleted successfully.</p>
                </div>
              @endif
              @if (session('delete_status') && session('delete_status') === False)
                <div class="alert alert-danger delete-error">
                  ...
                  <p>Failed to delete order(s). Please try again.</p>
                </div>
              @endif
              <div class="pull-left">
                Last updated:
            ...
            <div class="col-md-12">
              <div class="portlet portlet-blue">
                <div class="portlet-header">
                  <div class="caption text-white">Search Orders</div>
                </div>
                <div class="portlet-body">
                  ...
                  <input type="hidden" name="_token" id="csrf-token" value="{{ Session::token() }}" />
                    <div class="col-md-6">
                      ...
                      <!-- note to programmer: one of the 4 fields below "invoice #", "receipt #", "client name", "client ID" are mandatory for "Search orders". -->
                      <div class="form-group">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <p>
                      ...
                      {{ Form::open([ 'url' => url('admin/orders/delete') ]) }}
            ...
            <div class="col-lg-12" id="scrollDiv">
              <div class="portlet">
                <div class="portlet-header">
                  ...
                  <a href="{{ route('get_orders_list', [ 'sort' => 'country' ]) }}&page={{ request()->page }}" class="btn btn-green sortParam">
                    By Country &nbsp;<i class="fa fa-sort-alpha-desc"></i>
                  </a>&nbsp;
                  <a href="{{ route('get_orders_list', [ 'sort' => 'total_order_amount' ]) }}&page={{ request()->page }}" class="btn btn-pink sortParam">
                    By Total Orders &nbsp;<i class="fa fa-sort-amount-desc"></i>
                  </a>
                  <div class="tools">
                      ...
                      <table id="example1" class="table table-hover table-striped">
                        <thead>
                          <tr>
                            ...
                            <th><a href="#sort by login/email">Receipt #</a></th>
                            ...
                            <th><a href="#sort by customer id">Country</a></th>
