                    ...
                    <div class="modal-body">
                       ...
                       <div class="form-actions">
                          ...
                          <div class="col-md-offset-4 col-md-8">
                             <a href="javascript:;" class="btn btn-red progressbtn" data-id="{{ @$data['order']->id }}">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a>
                          </div>
                          @endif
                       </div>
                    </div>
                                ...
                                <div class="form-group">
                                   ...
                                   <div class="col-md-8">
                                      <p class="form-control-static">
                                         ...
                                         @endif
                                         (<a href="{{url('clients/invoices/'.$data['order']->user->id )}}">View all invoices</a>)
                                      </p>
                                   </div>
                                </div>
                                <div class="form-group">
                 ...
                 <div class="portlet">
                          ...
                          <div class="modal-dialog">
                             <div class="modal-content">
                                ...
                                <div class="modal-body">
                                   ...
                                   <div class="form-actions">
                                      <div class="col-md-offset-4 col-md-8">
                                         <a href="#" class="btn btn-red delete_selected">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a>
                                      </div>
                                   </div>
                                </div>
                             </div>
                                ...
                                <table class="table table-checkout table-striped">
                                   ...
                                   <tbody>
                                      ...
                                      <?php
                                       ...
                                       $main_price = ($v['price'] * $v['cycle']) + ($v['domain_price'] * $v['domain_cycle']);
                                       $domain_price = $v['domain_price'] * $v['domain_cycle'];
                                       ?>
                                      @else
                                      ...
                                      <?php
                                       ...
                                       if (empty(@$v['domain_price'])) {
                                          $row_price = $v['price'] * $cycle * $v['qty'];
                                       } else {
                                          $row_price = ($v['price'] * $cycle * $v['qty']) + $domain_price;
                                       }
                                       // if (empty($v['domain_price'])) {
                                       //    $row_price = $v['price'] * $v['cycle'] * $v['qty'];
                                       // } else {
                                       //    $row_price = ($v['price'] * $v['cycle'] * $v['qty']) + $domain_price;
                                       // }

                                       // if ($v->price != '') {
                                       //    $row_price = ($v->price * $v->cycle) + ($v->domain_price * $v->domain_cycle);

                                       // } else {
                                       // $row_price = $domain_price;
                                       // }
                                       ?>
                                      @if($v->type == 2)
                                      <?php $text = 'Transfer'; ?>
                                      ...
                                      <tr id="orderItem_{{$v->id}}">
                                            ...
                                            <table>
                                               ...
                                               <tr>
                                                  <td>
                                                     ...
                                                     @if (!empty($value->plan) && $v['plan_id'] == $value->plan->id)
                                               ...
                                               <?php } ?>
                                               <tr>
                                                  <td><?php if (!empty($v->setup_fee) && $v->setup_fee != '0.00') {
                                                         echo '<b>Setup fee:</b>'; ?>
                                                     <?php } ?></td>
                                               </tr>
                                               <!-- <ul class="list-style">
                                                     ...
                                                     <td>
                                                        ...
                                                        <?php
                                                         ...
                                                         if ($main_price != $v['price']) {
                                                            echo $v['cycle'] . ' years <br/>';
                                                            $domain_year = $v['domain_cycle'];
                                                         } else { ?>
                                                           {{$v['cycle']}} <?php if ($v['cycle'] == 1) echo "year";
                                                                           else echo "years"; ?> <br />
                                                           <?php $domain_year = ''; ?>
                                                        <?php } ?>
                                                        @if(!empty($v['plan_id']))
                                         ...
                                         <td class="text-right">
                                            ...
                                            <?php
                                             ...
                                             if ($main_price != $v['price']) { ?>
                                               RM {{ number_format(($v['price'] * $v['cycle']), 2) }} <br>
                                            ...
                                            <?php $d_price =  number_format(($v['price'] ? $v['price'] : '0'), 2); ?>
                                      ...
                                      <tr>
                                         ...
                                         <td class="text-center">
                                            RM {{ number_format($data['order']->discount - $discount, 2)}}
                                            @php
                                            $discount = $data['order']->discount;
                                            @endphp
                                         </td>
                                      ...
                                      <?php $gstPrice = 0; ?>
                                      @if(!empty($data['order']['gst_rate']) && $data['order']['gst_rate'] != "0.00")
                                      <tr>
                                         <td class="no-line" colspan="5"></td>
                                         <td class="no-line text-right">
                                            <h6><b>{{ number_format($gstRate,2) }}% GST:</b></h6>
                                         </td>
                                         <td class="no-line text-right" colspan="2">

                                            <h6><b>RM {{ number_format($gstAmount, 2) }}</b></h6>
                                         </td>
                                         <td class="no-line text-right"></td>
                                      </tr>
                                      @endif
                                      <tr>
                                         ...
                                         <td class="thick-line text-right" colspan="2">
                                            <h5 class="text-red"><b>RM {{number_format($grand_total + $gstPrice, 2)}}</b></h5>
                                         </td>
                                         <td class="thick-line text-right"></td>
                                      </tr>
                                      <input type="hidden" name="grand_total" class="grand_total" value="{{ $grand_total + $gstPrice }}">
                    ...
                    <div class="form-actions">
                       <div class="col-md-offset-5 col-md-7">
                          ...
                          <button type="submit" class="btn btn-red save_items">Save &nbsp;<i class="fa fa-floppy-o"></i></button>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a>
                       </div>
                    </div>
                    {{ Form::close() }}
                 </div>
