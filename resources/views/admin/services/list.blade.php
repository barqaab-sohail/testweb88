...
$breadcrumbs = [
    ...
    array('url' => 'javascript:void(0)', 'name' => $page_slug . '- Edit'),
];
?>
...
<div class="page-content">
    <div class="row">
        <div class="col-lg-12">
            <h2>{{$page_name}} Page<i class="fa fa-angle-right"></i> Edit</h2>
            ...
            <div class="pull-left"> Last updated: <span id="updated_date" class="text-blue">{{$recent_update}}</span>
            </div>
            <div class="clearfix"></div>
            <p></p>
            <div class="portlet">
                <div class="portlet-header">
                    ...
                    <p hidden="">base image url: {{url('').'/resources/assets/frontend/'}}</p>
                    <div class="clearfix"></div>
                ...
                <div class="form-actions none-bg"><a onclick="save_content(0)" href="javascript:void(0)"
                                                     class="btn btn-red">Save &amp; Preview &nbsp;<i
                                class="fa fa-search"></i></a>&nbsp; <a onclick="save_content(1)" href="javascript:void(0)"
                                                                       class="btn btn-blue">Save &amp; Publish &nbsp;<i
                                class="fa fa-globe"></i></a>&nbsp; <a href="javascript:void(0)" onclick="cancel_content()"
            ...
            <!-- end porlet -->
            <!-- Bottom Content -->
            @if($page_cms->bottom_content)
                <h4 class="block-heading">{{$page_name}} Plans &amp; General Features Listing</h4>
                <ul id="myTab" class="nav nav-tabs">
                    <!--<li class="active"><a href="#hosting-plans" data-toggle="tab">{{$page_name}} Plans</a></li> -->
                    @if(strpos(url()->current(),'email88') !== false)
                        <li><a href="#email88-special-features" data-toggle="tab">Email88 New & Special Features</a>
                        </li>
                    @endif
                    @if(strpos(url()->current(),'web88ir') !== false)
                        <li><a href="#web88ir-special-features" data-toggle="tab">Web88IR Value Innovation</a></li>
                    @endif
                    <li  class="active"><a class="active" href="#general-features" data-toggle="tab">General Features</a></li>
                ...
                <div id="myTabContent" class="tab-content">
                 <?php ?>  
                    <div id="hosting-plans" class="tab-pane fade in active">
                        <div @if($page_cms->is_ssl_page==1) style="display:none" @endif class="portlet">
                            <div class="portlet-header">
                                <div class="caption">Plan Features Listing</div>
                                <p style="margin-top: 32px" class="margin-top-10px"></p>
                                <a href="javascript:void(0)" data-target="#modal-add-plan-feature" data-toggle="modal"
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul role="menu" class="dropdown-menu">
                                        <li><a href="javascript:void(0)" onclick="open_modal_delete_selected()">Delete
                                                selected
                                                item(s)</a></li>
                                        <li class="divider"></li>
                                                    ...
                                                    <form id="plan_feature_frm" method="post" class="form-horizontal">
                                                        ...
                                                        <div class="form-actions">
                                                            <div class="col-md-offset-5 col-md-8">
                                                                <a href="javascript:void(0)" id="save_feature_plan"
                            ...
                            <div class="portlet-body">
                                <div class="table-responsive mtl">
                                        ...
                                        <form id="delete_client">
                                            ...
                                            @if($plan_features)
                                                ...
                                                @foreach($plan_features as $i)
                                                    ...
                                                    <tr>
                                                        <td><input class="pf_checkbox" name="id[]" value="{{$i->id}}"
                                                                   type="checkbox"/></td>
                                                        <td>{{$count_plan_features}}</td>
                                                        <td>
                                                            <span class="label label-xs label-{{$i->status?'success':'danger'}}">{{$i->status?'Active':'Inactive'}}</span>
                                                        </td>
                                                        <td>{{$i->title}}</td>
                                                        <td><a href="javascript:void(0)"
                                                               data-target="#modal-edit-plan-feature-{{$i->id}}"
                                                            ...
                                                            <a href="#" data-hover="tooltip" data-placement="top"
                                                               title="Delete"
                                                               data-target="#modal-delete-plan-feature-{{$i->id}}"
                                                            ...
                                                            <!--Modal delete start-->
                                                            <div id="modal-delete-plan-feature-{{$i->id}}" tabindex="-1"
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <p><strong>#{{$count_plan_features}}
                                                                                    :</strong> {{$i->title}}</p>
                                                                            <div class="form-actions">
                                                                                <div class="col-md-offset-4 col-md-8"><a
                                                                                            href="javascript:void(0)"
                                                                                            onclick="delete_single({{$i->id}})"
                                                                                            class="btn btn-red">Yes
                                                                                        &nbsp;<i
                                                            ...
                                                            <!-- modal delete end -->
                                                            <div id="modal-edit-plan-feature-{{$i->id}}" tabindex="-1"
                                                                 role="dialog" aria-labelledby="modal-login-label"
                                                                 aria-hidden="true" class="modal fade">
                                                                <div class="modal-dialog modal-wide-width">
                                                                    <div class="modal-content">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="col-md-6">
                                                                                        <div data-on="success"
                                                                                             data-off="primary"
                                                                                             class="make-switch">
                                                                                            <input id="edit_pf_status_{{$i->id}}"
                                                                                                   type="checkbox"
                                                                                                   @if($i->status) checked="checked" @endif/>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="col-md-6">
                                                                                        <input type="text"
                                                                                               id="edit_pf_title_{{$i->id}}"
                                                                                               class="form-control"
                                                                                               placeholder="eg. RAM"
                                                                                               value="{{$i->title}}">
                                                                                        <p class="red_error"
                                                                                           id="pf_error_title{{$i->id}}"></p>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-actions">
                                                                                    <div class="col-md-offset-5 col-md-8">
                                                                                        <a
                                                                                                href="javascript:void(0)"
                                                                                                onclick="edit_plan_feature({{$i->id}})"
                                    ...
                                    <div class="clearfix"></div>
                                    <span>Showing {{$plan_features->firstItem()}} to {{$plan_features->lastItem()}}
                                        of {{$plan_features->total()}}</span>
                        ...
                        <div class="portlet">
                            <div class="portlet-header">
                                <div class="caption">{{$page_name}} Plans Listing</div>
                                <p style="margin-top: 32px" class="margin-top-10px"></p>
                                <a href="{{url('admin/services/new/'.$page_slug)}}" class="btn btn-success">Add New Plan
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul role="menu" class="dropdown-menu">
                                        <li><a href="javascript:void(0)" onclick="open_modal_delete_selected_hp()">Delete
                                            ...
                                            @if(count($hosting_plan)>0)
                                                @foreach($hosting_plan as $i)
                                                    <tr>
                                                        ...
                                                        @if($page_cms->is_ssl_page==1)
                                                            <td>
                                                                @if($i->price_type=='Recurring')
                                                                    <span>3 Years @ </span> {{$i->price_triennially or '0'}}
                                                                    <span>/yr</span>
                                                                    <span>2 Years @ </span> {{$i->price_biennially or '0'}}
                                                                    <span>/yr</span><br>
                                                                    <span>1 Years @ </span> {{$i->price_annually or '0'}}
                                                                    <span>/yr</span><br>
                                                                @endif
                                                        ...
                                                        @else
                                                            <td>@if($i->price_type=='Recurring')
                                                                    <span>RM</span> {{$i->price_annually or '0'}}
                                                                    <span>/yr</span>@endif
                                                                @if($i->price_type=='One Time')
                                                                    <span>RM</span>{{$i->price_monthly or '0'}}
                                                                    <span>/mo</span>
                                                                @endif
                                                        ...
                                                        <td><span class="red"><i
                                                                        class="fa fa-check red"></i>&nbsp;{{$i->promo_behaviour}}</span>
                                                        </td>
                                                        <td><input type="text" id="{{$i->id}}" class="form-control"
                                                                   value="{{$i->sort_order}}"></td>
                                                        <td>
                                                            <a href="{{url('/admin/services/edit/'.$i->id.'/'.$page_slug)}}"
                                                               title="Edit"><span
                                                                        class="label label-sm label-success"><i
                                                                    ...
                                                                    data-placement="top"
                                                                    title="Delete"
                                                                    data-target="#modal-delete-plan-hosting-{{$i->id}}"
                                                                    data-toggle="modal"><span
                                                                        class="label label-sm label-red"><i
                                                                            class="fa fa-trash-o"></i></span></a>
                                                           
                                                            <div id="modal-delete-plan-hosting-{{$i->id}}" tabindex="-1"
                                                                 role="dialog" aria-labelledby="modal-login-label"
                                                                 aria-hidden="true" class="modal fade">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <p><strong>#{{$i->id}}
                                                                                    :</strong> {{$i->plan_name}}</p>
                                                                            <div class="form-actions">
                                                                                <div class="col-md-offset-4 col-md-8"><a
                                                                                            href="javascript:void(0)"
                                                                                            onclick="delete_single_hp({{$i->id}})"
                                                                                            class="btn btn-red">Yes
                                                                                        &nbsp;<i
                                                                                                class="fa fa-check"></i></a>&nbsp;
                                                                                    <a href="#" data-dismiss="modal"
                    ...
                    <div id="faq" class="tab-pane fade">
                        ...
                        <div class="portlet">
                            <div class="portlet-header">
                                ...
                                <a href="javascript:void(0)" onclick="store_faq(0)" data-target="#modal-add-faq"
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul role="menu" class="dropdown-menu">
                                        <li><a href="javascript:void(0);" onclick="modalDeleteSelectedFaq()">Delete
                                                selected
                                                item(s)</a></li>
                                        <li class="divider"></li>
                                        <li><a href="#" data-target="#modal-delete-all" data-toggle="modal">Delete
                                            ...
                                            @if(count($faq)>0)
                                                @foreach($faq as $i)
                                                    <tr>
                                                        ...
                                                        <td>{{$i->id}}</td>
                                                        <td>
                                                            <div id="statusval_<?php echo $i->id; ?>">{{$i->title}}</div>
                                                        </td>
                                                        <td>
                                                            <span class="label label-xs label-{{$i->status?'success':'danger'}}">{{$i->status?'Active':'Inactive'}}</span>
                                                        </td>

                                                        <td><a href="javascript:void(0)" onclick="store_faq({{$i->id}})"
                                                               title="Edit"><span
                                                                        class="label label-sm label-success"><i
                                                                            class="fa fa-pencil"></i></span></a> <a
                                                                    href="#"
                    ...
                    @if(strpos(url()->current(),'email88') !== false)
                        @include('admin.email88.list')
                    @endif
                    @if(strpos(url()->current(),'web88ir') !== false)
                        @include('admin.web88ir.list')
                    @endif
                    <div id="general-features" class="tab-pane fade in active">
                        <div class="portlet">
                            <div class="portlet-header">
                                ...
                                <div class="table-responsive mtl">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tr>
                                            <td>1</td>
                                            <td>
                                                <span class="label label-xs label-{{(isset($general_features[0]['heading_status']) && $general_features[0]['heading_status'])?'success':'danger'}}">{{(isset($general_features[0]['heading_status']) && $general_features[0]['heading_status']) ?'Active':'Inactive'}}</span>
                                            </td>
                                            <td>{{(isset($general_features[0]['heading']) && $general_features[0]['heading']) ? $general_features[0]['heading'] : ''}}</td>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div data-on="success"
                                                                                     ...
                                                                                     class="make-switch">
                                                                                    <input name="status" type="checkbox"
                                                                                           @if(isset($general_features[0]['heading_status']) && $general_features[0]['heading_status']==1)checked="checked" @endif/>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <input type="text" name="heading"
                                                                                       class="form-control"
                                                                                       value="{{(isset($general_features[0]['heading']) && $general_features[0]['heading']) ? $general_features[0]['heading'] : ''}}">
                                                                                <p class="red_error"
                                                                                   id="gf_heading"></p>
                                                                            </div>
                                                                        </div>
                        ...
                        <div class="portlet">
                            <div class="portlet-header">
                                ...
                                <p class="margin-top-10px"></p>
                                <a href="javascript:void(0)" onclick="add_general_feature(0)" class="btn btn-success">Add
                                    New
                                    &nbsp;<i class="fa fa-plus"></i></a>&nbsp;
                                <div class="btn-group">
                                    <button type="button" class="btn btn-primary">Delete</button>
                                    ...
                                    <ul role="menu" class="dropdown-menu">
                                        <li><a href="javascript:void(0)" onclick="gf_open_modal_delete_selected()">Delete
                                                selected item(s)</a></li>
                                        <li class="divider"></li>
                                        <li><a href="#" data-target="#modal-delete-all" data-toggle="modal">Delete
                                                all</a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-striped">
                                    ...
                                    <form id="delete_general_features">
                                        {{csrf_field()}}
                                        <?php $count_gf = 0;?>
                                        @if(count($general_features->where('ssl_page',0))>0)
                                            @foreach($general_features->where('ssl_page',0) as $i)
                                                <?php $count_gf++;?>
                                                <tr>
                                                    <td><input type="checkbox" data-count="{{$count_gf}}"
                                                               class="gff_checkbox" value="{{$i->id}}" name="id_gf[]">
                                                    </td>
                                                    <td>{{$count_gf}}</td>
                                                    <td>
                                                        <span class="label label-xs label-{{$i->status?'success':'danger'}}">{{$i->status?'Active':'Inactive'}}</span>
                                                    ...
                                                    <td>{{$i->title}}</td>
                                                    <td><a href="javascript:void(0)"
                                                           onclick="edit_general_feature({{$i->id}},0)"
                                                           data-hover="tooltip"
                                                           data-placement="top" title="Edit"><span
                                                                    class="label label-sm label-success"><i
                                                                        class="fa fa-pencil"></i></span></a> <a href="#"
                                                                                                                ...
                                                                                                                data-placement="top"
                                                                                                                title="Delete"
                                                                                                                data-target="#modal-delete-general-feature-{{$i->id}}"
                                                                                                                data-toggle="modal"><span
                                                                    class="label label-sm label-red"><i
                                                                        class="fa fa-trash-o"></i></span></a>

                                                        <!--Modal delete start-->
                                                        <div id="modal-delete-general-feature-{{$i->id}}" tabindex="-1"
                                                             role="dialog" aria-labelledby="modal-login-label"
                                                             aria-hidden="true" class="modal fade">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <p><strong>#{{$count_gf}}:</strong>{{$i->title}}
                                                                        </p>
                                                                        <div class="form-actions">
                                                                            <div class="col-md-offset-4 col-md-8">
                                                                                <button type="button"
                                                                                        onclick="delete_gf_single({{$i->id}})"
                                                                                        class="btn btn-red">Yes &nbsp;<i
                                                                                            class="fa fa-check"></i>
                                                                                </button>&nbsp; <a href="#"
                                                                                                   data-dismiss="modal"
                        ...
                        <div class="portlet @if($page_cms->is_ssl_page==0) hidden @endif">
                            <div class="portlet-header">
                                <div class="caption">All Our Plans Include Listing</div>
                                <p class="margin-top-10px"></p>
                                <a href="javascript:void(0)" onclick="add_general_feature(1)" class="btn btn-success">Add
                                    New
                                    &nbsp;<i class="fa fa-plus"></i></a>&nbsp;
                                <div class="btn-group">
                                    <button type="button" class="btn btn-primary">Delete</button>
                                    ...
                                    <ul role="menu" class="dropdown-menu">
                                        <li><a href="javascript:void(0)" onclick="gf_open_modal_delete_selected(1)">Delete
                                                selected item(s)</a></li>
                                        <li class="divider"></li>
                                        <li><a href="#" data-target="#modal-delete-all" data-toggle="modal">Delete
                                                all</a>
                                            ...
                                            @if(count($general_features->where('ssl_page',1))>0)
                                                @foreach($general_features->where('ssl_page',1) as $i)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$i->title}}</td>
                                                        <td><a href="javascript:void(0)"
                                                               onclick="edit_general_feature({{$i->id}},1)"
                                                            ...
                                                            <!--Modal delete start-->
                                                            <div id="modal-delete-general-feature-{{$i->id}}"
                                                                 tabindex="-1"
                                                                 role="dialog" aria-labelledby="modal-login-label"
                                                                 aria-hidden="true" class="modal fade">
                                                                <div class="modal-dialog">
...
@section('custom_scripts')
    <link type="text/css" rel="stylesheet"
          href="{{url('').'/resources/assets/admin/'}}vendors/jquery-nestable/nestable.css">
    ...
    <link type="text/css" rel="stylesheet"
          href="{{url('').'/resources/assets/admin/'}}css/responsive-leyouts_webqom_front.css">
    ...
    <script type="text/javascript">
        ...
        $(document).on('submit', '#plan_feature_frm', function (event) {
            ...
            $.ajax({
                ...
                .done(function () {
                    window.location.href = page_url + "{{$page_slug}}";
                })
                .fail(function () {
                    console.log("error");
                })
        ...
        function save_content(publish) {
            ...
            $.ajax({
                ...
                .done(function (response) {
                    ...
                    if (publish == 0) {
                        window.open(base_url + "/services/{{$page_slug}}/preview");
                    }
        ...
        $('#frm_general_features').submit(function (event) {
            ...
            $.ajax({
                ...
                .done(function (response) {
                    ...
                    window.location.href = page_url + "{{$page_slug}}?tab=general-features";
        ...
        //    })
        //    .done(function() {
        //        window.location.href = page_url + "{{$page_slug}}?tab=email88-special-features";
        //    })
        //    .fail(function(response) {
        //        //$('#gf_heading').html(response.responseJSON.heading);
        //    })
        ...
        function save_web88ir_content() {
            ...
            $.ajax({
                ...
                .done(function () {
                    window.location.href = page_url + "{{$page_slug}}?tab=web88ir-special-features";
                })
                .fail(function () {
                    console.log("error");
                })
        ...
        function web88ir_open_modal_delete_selected(ssl_page, e = null) {
            ...
            if (selected < 1) {
                ...
                /*get seleccted users details*/
                if ("{{(strpos(url()->current(),'email88') !== false)?'email88':''}}" === "email88") {
                    $.ajax({
        ...
        $('#frm_faq').submit(function (event) {
            ...
            $.ajax({
                ...
                .done(function () {
                    window.location.href = base_url + '/admin/services/{{$page_slug}}?tab=faq';
                })
                .fail(function (response) {
                    console.log("error");
                    validation_errors = response.responseJSON;
            ...
            if (id > 0) {
                $.ajax({
                    ...
                    .done(function (response) {
                        ...
                        //window.location.href=base_url+'/admin/service/{{$page_slug}}?tab=faq';
                    })
                    .fail(function () {
                        console.log("error");
                    })
