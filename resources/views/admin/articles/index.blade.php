                ...
                <div class="modal-body">
                  ...
                  <div class="form">
                    <form class="form-horizontal form-add-article" method="POST" action="{{route('admin.articles.store')}}" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label class="col-md-3 control-label">Meta Name Keywords</label>
                        <div class="col-md-6">
                          <textarea name="meta_keyword" class="form-control meta_keyword" id="meta_keyword"></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-md-3 control-label">Meta Name Description</label>
                        <div class="col-md-6">
                  ...
                  @foreach($articles as $article)
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="{{ route('admin.articles.show', ['id' => $article->id, 'slug' => $article->title]) }}" data-hover="tooltip" data-placement="top" title="View/Reply Comment"><span class="label label-sm label-warning"><i class="fa fa-search"></i></span></a>
              ...
              <div class="form">
                <form class="form-horizontal form-update-article" method="POST" action="{{route('admin.articles.update')}}">
                  ...
                  <div class="form-group">
                        <label class="col-md-3 control-label">Meta Name Keywords</label>
                        <div class="col-md-6">
                          <textarea name="meta_keyword" class="form-control meta_keywords" id="meta_keyword"></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-md-3 control-label">Meta Name Description</label>
                        <div class="col-md-6">
                          <textarea name="meta_description" class="form-control meta_descriptions" id="meta_description"></textarea>
                        </div>
                      </div>
                  <div class="form-group">
                    <label class="col-md-3 control-label">Post Date <span class="text-red">*</span></label>
          ...
          $.ajax({
              ...
              .done(function(res){
                  ...
                  if (res.error == 0) {
                      ...
                      $('.meta_descriptions').empty().html(article.meta_descriptions);
                      $('.meta_keywords').empty().html(article.meta_keyword);
