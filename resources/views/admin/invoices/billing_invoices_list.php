                ...
                <div class="portlet-body">
                  ...
                  <input type="hidden" name="_token" id="csrf-token" value="{{ Session::token() }}" />
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        <label class="col-md-4 control-label">Invoice Date Date</label>
                        <div class="col-md-8">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          ...
                          note to programmer: either "client ID" or "client name" field is compulsory.
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-md-4 control-label">Client Name </label>
                      ...
                      <table id="example1" class="table table-hover table-striped">
                        <thead>
                          <tr>
                            ...
                            <th><a href="#sort by order date">Due Date</a></th>
                            <th><a href="#sort by Total">Total</a></th>

                            
                            <th><a href="#sort by customer id">Payment Date</a></th>
                            <th><a href="#sort by Total">Transaction Id</a></th>
