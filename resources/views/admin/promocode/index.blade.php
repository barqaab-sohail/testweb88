            ...
            <div class="col-lg-12">
                <div class="portlet">
                    <div class="portlet-header">
        	            ...
        	            <a href="{{ url('admin/promocodes/addNew') }}" class="btn btn-success">Add Promo Code &nbsp;<i class="fa fa-plus"></i></a>&nbsp;
                        <div class="btn-group">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($promocodes as $promocode)
	                                    <tr>
                                            ...
                                            <td>{{ $promocode->times_to_use }}</td>

                                            <td>
                                                @if (\App\Http\Models\Admin\Promocodes::find($promocode->id)->validPromoCode())
	                                        ...
	                                        <td>
                                            	<a href="{{ url('admin/promocodes/editPromoCode/' . $promocode->id) }}" data-hover="tooltip" data-placement="top" title="Edit">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
	                                                        ...
	                                                        <div class="modal-body">
            		                                            ...
            		                                            <div class="form-actions">
                    			                                    <div class="col-md-offset-4 col-md-8">
                                                                    	<a href="{{ url('web88cms/promocodes/delete/' . $promocode->id) }}?redirect={{ Request::url() }}" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp;
                                                                        <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a>
                                                                    </div>
		                                                        </div>
        	                                                </div>
