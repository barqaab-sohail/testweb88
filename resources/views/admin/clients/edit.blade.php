  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <ul id="myTab" class="nav nav-tabs">
        ...
        <li><a href="#past-orders" data-toggle="tab">Past Orders &nbsp;<span class="badge badge-red">{{ $orders->total() }}</span></a></li>
        <li class="{{request('type') == 'allInvoice' ? 'active' : ''}}"><a href="#invoices" data-toggle="tab">Invoices</a></li>
                  ...
                  <div class="form-horizontal">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        ...
                        My Billing address is the same as account information above.
                      </div>
                    </div>
                    <div class="clearfix"></div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <input type="text" name="billing_first_name" id="billing_first_name" @if($clients->client_billing) value="{{$clients->client_billing->billing_first_name}}" @endif class="form-control" placeholder="">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <input type="text" name="billing_last_name" id="billing_last_name" @if($clients->client_billing) value=" {{$clients->client_billing->billing_last_name}} " @endif class="form-control" placeholder="">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <input type="text" name="billing_company" @if($clients->client_billing) value="{{$clients->client_billing->billing_company}}" @endif id="billing_company" class="form-control" placeholder="">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <input type="text" name="billing_email" @if($clients->client_billing) value="{{$clients->client_billing->billing_email}}" @endif id="billing_email" class="form-control">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <input type="text" name="billing_phone_number" @if($clients->client_billing) value="{{$clients->client_billing->billing_phone_number}}" @endif id="billing_phone_number" class="form-control">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <input name="billing_mobile_phone" @if($clients->client_billing) value="{{$clients->client_billing->billing_mobile_number}}" @endif id="billing_mobile_phone" type="text" class="form-control">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <input name="billing_address_1" @if($clients->client_billing) value="{{$clients->client_billing->billing_address_1}}" @endif id="billing_address_1" type="text" class="form-control">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <input type="text" name="billing_address_2" @if($clients->client_billing) value="{{$clients->client_billing->billing_address_2}}" @endif id="billing_address_2" class="form-control">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <select name="billing_country" id="billing_country" class="form-control">
                          <option value="">-- Please select --</option>
                          @foreach($countries as $country)
                          <option @if($clients->client_billing && $clients->client_billing->billing_country_id==$country->id) selected @endif value="{{$country->id}}">{{$country->name}}</option>
                          @endforeach
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <input name="billing_postal_code" @if($clients->client_billing) value="{{$clients->client_billing->billing_postal_code}}" @endif id="billing_postal_code" type="text" class="form-control">
              ...
              <div class="table-responsive mtl">
                <table class="table table-hover table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{ $i++ }}</td>
                      <td><a href="{{url('admin/billing_invoice_edit').'/'.$order->id}}">MY-{{ $order->transaction_id }}</a></td>
                      <td><a href="{{url('admin/billing_invoice_edit').'/'.$order->id}}">{{ $order->id }}</a></td>
                      <td>{{$order->created_at}}</td>
                      <td>RM {{ number_format($order->price, 2)}}</td>
                      <td>{{ $payments[$order->payment_method_id] }}</td>
                      <td>
                ...
                <div class="tool-footer text-right">
                  <p class="pull-left">Showing page {{ $orders->currentPage() }} of {{ $orders->lastPage() }} total {{ $orders->total() }} entries</p>
                  {{$orders->links()}}
                </div>
                <div class="clearfix"></div>
  ...
  function load_countries_billing() {
    ...
    $.ajax({
      ...
      .done(function(response) {
          ...
          for (var i = 0; i < response.length; i++) {
            var stat_id = '';
            if ('{{ $clients->client_billing }}') {}
            if (response[i].id == stat_id) {
        ...
        var state_id = $("#billing_state option:selected").val(); $("#billing_city").html("<option value=''>-- Please select --</option>"); $.ajax({
          url: base_url + '/get_city/' + state_id,
          type: 'GET',
          dataType: ' json',
        })
