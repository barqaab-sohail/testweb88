<!DOCTYPE html>
<html lang="en"><!-- InstanceBegin template="/Templates/admin_cms.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
<link type="text/css" rel="stylesheet" href="{{url('').'/resources/assets/admin/'}}icons/font-awesome.min.css">
<meta charset="utf-8">
...
<!--BEGIN TO TOP--><a id="totop" href="#"><i class="fa fa-angle-up"></i></a><!--END BACK TO TOP-->
  <div id="wrapper"><!--BEGIN TOPBAR-->
        ...
        <nav id="sidebar" role="navigation" class="navbar-default navbar-static-side">
          ...
          <!-- <li @if(isset($page) && $page=='enquiry') class="active" @endif><a   href="{{route('enquires-list')}}"><i class="fa fa-info-circle fa-fw"></i><span class="menu-title">Services Enquiry Listing</span></a></li> -->
          ...
          <li><a href="promo_codes_list.html"><i class="fa fa-qrcode fa-fw"></i><span class="menu-title">Promo Codes</span></a></li>
                    ...
                    <li <?php if(isset($page) && $page == 'Tickets' || ($page=='enquiry' && Request::segment(4)=='edit') ) { echo 'class="active mm-active"'; } ?> ><a href="/admin/support_tickets"><i class="fa fa-wrench fa-fw"></i><span class="menu-title">Support Tickets/Service Enquiry/Ask For Quote Listing</span></a></li>
                    ...
                    <li @if(isset($page) && $page=='blog') class="active mm-active" @endif><a href="{{route('admin.articles.index')}}"><i class="fa fa-check-circle fa-fw"></i><span class="menu-title">Blog</span></a></li>
                    <li><a href="#" @if(isset($page) && $page=='blog') aria-expanded="true" @endif><i class="fa fa-globe fa-fw"></i><span class="menu-title">Domains</span><span class="fa arrow"></span></a>
