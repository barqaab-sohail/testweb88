...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{url('').'/resources/assets/admin/'}}vendors/metisMenu/metisMenu.min.css">
        ...
        <div id="wrapper">
            ...
            <nav id="topbar" role="navigation" style="margin-bottom: 0;" class="navbar navbar-default navbar-static-top">
                <div class="navbar-header">
                    ...
                    <a id="logo" href="{{url('/')}}" target="_blank" class="navbar-brand"><img src="{{url('').'/resources/assets/admin/'}}images/logo_web88.png"></a>
                </div>
                                    ...
                                    <div class="col-md-8">
                                        <form id="frm_change_pic">
                                            ...
                                            <div class="text-15px margin-top-10px">
                                                <img id="profile_pic_popup" width="100px" src="{{$pic}}" alt="Avatar" class="img-responsive"><br />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-icon"><i class="fa fa-key"></i> <input id="current_password" name="current_password" type="password" placeholder="Current Password" class="form-control" />
                                                <div class="red_error" id="err_current_password"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-icon"><i class="fa fa-key"></i> <input id="password" name="password" type="password" placeholder="New Password" class="form-control" />
                                                ...
                                                <div class="red_error" id="err_new_password"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-icon"><i class="fa fa-key"></i> <input id="confirm_password" name="password_confirmation" type="password" placeholder="Confirm New Password" class="form-control" /><span class="text-10px">(Password length should atleast be 12 characters)</span>
                                                <div class="red_error" id="err_confirm_password"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-actions">
            ...
            <nav id="sidebar" role="navigation" class="navbar-default navbar-static-side">
                <div class="sidebar-collapse menu-scroll">
                    <ul id="side-menu" class="nav">
                        ...
                        <li @if(isset($page) && $page=='billing_invoice_list' ) class="active" @endif><a href="{{url('/admin/billing_invoice_list')}}"><i class="fa fa-list fa-fw"></i><span class="menu-title">Invoices Listing</span></a></li>
                        <li><a href="{{ url('admin/billing_invoice_new')}}"><i class="fa fa-plus fa-fw"></i><span class="menu-title">Add New Invoice</span></a></li>
                        <li @if(isset($page) && $page=='receipts_list' ) class="active" @endif><a href="{{ url('admin/receipts_list')}}"><i class="fa fa-file fa-fw"></i><span class="menu-title">Receipts Listing</span></a></li>
                        ...
                        <li><a href="{{url('/admin/orders_list')}}"><i class="fa fa-shopping-cart fa-fw"></i><span class="menu-title">Orders</span><!-- <span class="badge badge-blue">3</span> --></a></li>
                        <li class="sidebar-heading">
                            <h4>Services</h4>
                        </li>
                        <li @if(isset($page) && $page=='categories' && \Request::route()->getName() != 'edit_domain_main_page' && \Request::route()->getName() != 'edit_single_domain_transfer_page') class="active" @endif><a href="{{url('/admin/categories')}}"><i class="fa fa-cog fa-fw"></i><span class="menu-title">Categories</span></a> </li>
                        <li @if(isset($page) && $page=='domains' ) class="active mm-active" @endif>
                            <a href="#" @if(isset($page) && $page=='domains' ) aria-expanded="true" @endif><i class="fa fa-globe fa-fw"></i>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li @if(isset($sub_page) && $sub_page=='bulk_domain' ) class="active" @endif>
                                    <a href="{{url('/web88/admin/bulk_domain')}}">Bulk Domain Pricing List</a>
                                </li>
                        ...
                        <!--  <li @if(isset($page) && $page=='enquiry' && Request::segment(4)!='edit' ) class="active" @endif><a   href="{{route('enquires-list')}}"><i class="fa fa-info-circle fa-fw"></i><span class="menu-title">Services Enquiry Listing</span></a></li> -->
                        <li class="sidebar-heading">
                            <h4>Promotions</h4>
                        </li>
                        <li @if(isset($page) && $page=='promotions' ) class="active" @endif><a href="{{ url('/admin/promotions/globalDiscounts/')}}"><i class="fa fa-cog fa-fw"></i><span class="menu-title">Global Discounts</span></a> </li>
                        <li @if(isset($page) && $page=='promocode' ) class="active" @endif><a href="{{ url('/admin/promocodes')}}"><i class="fa fa-qrcode fa-fw"></i><span class="menu-title">Promo Codes</span></a></li>
                        <li @if(isset($page) && $page=='newsletter' ) class="active" @endif><a href="{{url('/newsletter')}}"><i class="fa fa-envelope fa-fw"></i><span class="menu-title">Newsletter Subscription</span></a> </li>
                        <li class="sidebar-heading">
                            <h4>Support</h4>
                        </li>
                        <li <?php if (isset($page) && $page == 'Tickets' || ($page == 'enquiry' && Request::segment(4) == 'edit')) {
                                echo 'class="active mm-active"';
                            } ?>><a href="/admin/support_tickets"><i class="fa fa-wrench fa-fw"></i><span class="menu-title">Support Tickets/Service Enquiry/Ask For Quote Listing</span></a></li>
                        <li class="sidebar-heading">
                            <h4>Banners</h4>
                        </li>
                        <li @if(isset($page) && $page=='banners' ) class="active mm-active" @endif><a href="{{route('admin.banners.index')}}"><i class="fa fa-check-circle fa-fw"></i><span class="menu-title">Index Banners</span></a></li>
                        <li class="sidebar-heading">
                            <h4>CMS Pages</h4>
                        </li>
                        <li @if(isset($page) && $page=='blog' ) class="active" @endif><a href="{{route('admin.articles.index')}}"><i class="fa fa-check-circle fa-fw"></i><span class="menu-title">Blog</span></a></li>
                        <li @if(\Request::route()->getName() == 'edit_domain_main_page' || \Request::route()->getName() == 'edit_single_domain_transfer_page') class="active mm-active" @endif><a href="#" @if(\Request::route()->getName() == 'edit_domain_main_page' || \Request::route()->getName() == 'edit_single_domain_transfer_page') aria-expanded="true" @endif><i class="fa fa-globe fa-fw"></i><span class="menu-title">Domains</span><span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li @if(\Request::route()->getName() == 'edit_domain_main_page') class="active" @endif><a href="{{ route('edit_domain_main_page') }}">Domains Main Page</a></li>
                                <li><a href="#">Single Domain Search</a></li>
                                <li><a href="bulk_domain_search_edit.html">Bulk Domain Search</a></li>
                                <li @if(\Request::route()->getName() == 'edit_single_domain_transfer_page') class="active" @endif><a href="{{route('edit_single_domain_transfer_page')}}">Single Domain Transfer</a></li>
                        ...
                        <li><a href="{{ url('admin/gst_rates') }}"><i class="fa fa-dollar fa-fw"></i><span class="menu-title">GST Rate Setup</span></a></li>

                        {{-- Added by Rejohn --}}
                        <li @if(isset($page) && $page=='meta_name' ) class="active" @endif><a href="{{ url('admin/meta_name')}}"><i class="fa fa-dollar fa-fw"></i><span class="menu-title">Meta Name Setup</span></a></li>
                        {{-- Added by Rejohn --}}
                    </ul>
                </div>
            </nav>
